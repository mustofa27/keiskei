package com.keiskeismartsystem.GCM;
...
public class GcmMessageHandler extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        if(componentInfo.getPackageName().equalsIgnoreCase("com.keiskeismartsystem")){
...
//            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            if (flag == 'C'){
                Intent intent = new Intent("com.keiskeismartsystem.GCMMESSAGE");
                ...
                Intent intent = new Intent("com.keiskeismartsystem.GCMMESSAGE.Notification");
                intent.putExtras(bundle);
...
//            sendOrderedBroadcast(intent, null);
    ...
    private class LoadImage extends AsyncTask<String, String, Bitmap> {
        ...
        protected Bitmap doInBackground(String... args) {
            ...
            try {
                Log.v("keiskeidebug", "https://keiskei.co.id/data/chat_mobile/" + args[0]);
                bitmap_t = BitmapFactory.decodeStream((InputStream) new URL("https://keiskei.co.id/data/chat_mobile/" + args[0]).getContent());
